...
export function renderModalCategories(categories,) {
    ...
    select.innerHTML = ""; // Vider pour éviter les doublons en cas d'ouverture multiples de la modale
    
    // Option vide : Force l'utilisateur à remplir lui-même les champs
